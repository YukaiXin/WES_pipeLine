...
-T CombineVariants \
   ...
   --variant:$sample1 sort_$sample1_indel_snps.vcf \
   --variant:$sample2 sort_$sample2_indel_snps.vcf \
   --variant:$sample3 sort_$sample3_indel_snps.vcf \
   --variant:$sample4 sort_$sample4_indel_snps.vcf \
   --variant:$sample5 sort_$sample5_indel_snps.vcf \
   --variant:$sample6 sort_$sample6_indel_snps.vcf \
